        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/tickets" className="text-gray-600 hover:text-indigo-600 text-sm">Support Tickets</Link></li>
              ...
              <li><Link to="/refund-policy" className="text-gray-600 hover:text-indigo-600 text-sm">Refund &amp; Cancellation</Link></li>
              <li><Link to="/cookies" className="text-gray-600 hover:text-indigo-600 text-sm">Cookie Policy</Link></li>
            </ul>
          </div>
          <div>
