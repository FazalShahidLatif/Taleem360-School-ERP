...
export const CookiePolicy: React.FC = () => {
  useEffect(() => {
    document.title = 'Cookie Policy - Taleem360 School Cloud ERP';
    ...
    metaDescription.setAttribute('content', 'Read about how cookies and session storage are used on Taleem360 school management portal dashboards.');
    ...
    canonicalLink.setAttribute('href', 'https://www.taleem360.online/cookies');
  }, []);
